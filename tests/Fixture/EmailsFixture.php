...
class EmailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email' => ['type' => 'string', 'fixed' => true, 'length' => 100, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'emails_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_contact'], 'references' => ['contacts', 'ID'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
